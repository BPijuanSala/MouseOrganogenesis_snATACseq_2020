...
peaks=$wd/05_MACS2_afterQC/embryo_revision1_nuclearGenes_passedQC_summits_extended500bp_overlapped_noblacklist_TSS_merged.bed_subset00

echo "creating matrix "

/path/to/directory/bioinformatic_resources/snATAC/bin/snATAC_bmat_BPS -i $bedFile -x $Barcodes -y $peaks -o embryo_revision1_allPeaks_passedQC_subset00.mat
