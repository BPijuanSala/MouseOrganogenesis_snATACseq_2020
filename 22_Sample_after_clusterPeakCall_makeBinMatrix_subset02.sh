...
peaks=$wd/10_peaks_all/peaks_celltypes_extended500bp_qvalThreshold_overlapped_TSSGeneralPeaks_merged_noblacklist.bed_subset02


echo "creating matrix "

/path/to/directory/bioinformatic_resources/snATAC/bin/snATAC_bmat_BPS -i $bedFile -x $Barcodes -y $peaks -o embryo_revision1_allPeaks_afterclusterPeak_passedQC_subset02.mat
